...
#frame 1 
frame1= tk.Frame(root, bg="gray", padx=200, pady=210)
frame1.pack(padx=525, pady=100, fill="both", expand=True)
...
root.geometry("1920x1080")
root.config(background="black")
frame3=tk.Frame(root, bg="grey", padx=200, pady=210)
frame3.pack(padx=525, pady=100, fill="both", expand=True)
